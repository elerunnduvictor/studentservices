...
OC.employees = [
  ...
  { id: 'geraldine-bean', name: 'Geraldine Susan Bean', title: 'Graduation Coordinator', dept: 'records', level: 5, status: 'FTE', reportsTo: 'tyson-bell',
    ...
    kpis: ['Graduation application case completion rate', 'Award processing rate', 'Number of rescinded degrees', 'Application and awarding QA'], email: 'sbean@byupw.edu', photoUrl: '../photos/records/geraldine-bean.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAR8feRUQUqRbS9IFJkfhY6Ae-dI_3KnvPYc7_B5RaXvmE?e=SVgmsJ' },
