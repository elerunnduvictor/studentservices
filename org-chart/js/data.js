...
OC.employees = [
  ...
  { id: 'vp', name: 'Ben Packer', title: 'Vice President of Student Services', dept: 'executive', level: 1, status: 'FTE', reportsTo: null,
    ...
    kpis: ['Overall student satisfaction scores', 'Student retention and completion rates', 'Operational efficiency across departments'], email: '', photoUrl: '../photos/executive/vp.jpeg' },
  ...
  { id: 'alison-cundiff', name: 'Alison Cundiff', title: 'Director of Enrollment & Retention', dept: 'enrollment', level: 2, status: 'FTE', reportsTo: 'vp',
    ...
    kpis: ['Enrollment & Retention budget', 'Enrollment, retention, completion (primary)', 'Overall student autonomy and satisfaction (secondary)'], email: '', photoUrl: '../photos/enrollment/alison-cundiff.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAFhc5UkuwgTapnxWheHmYRAeUt6L6jGcomm-gS_hKDWbg?e=v2NPg4' },
  { id: 'steven-thomas', name: 'Steven K. Thomas', title: 'Dean of Students', dept: 'dean', level: 2, status: 'FTE', reportsTo: 'vp',
    ...
    kpis: ['No material audit, legal, or accreditation findings attributable to Dean of Students governance', 'Annual DOS budget', 'Overall student satisfaction (primary)'], email: '', photoUrl: '../photos/dean/steven-thomas.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAJCeQuk9fHTbFRX-_VINCFAXaStbvWN2DK4_tsSELnmmQ?e=UfES01' },
  { id: 'jacob-adams', name: 'Jacob Adams', title: 'Director of Digital Operations', dept: 'digital', level: 2, status: 'FTE', reportsTo: 'vp',
    ...
    kpis: ['Overall Stakeholder CSAT', 'Digital Ops budget', 'Costs saved by customers due to Digital Ops technologies (secondary)', 'Overall student autonomy (secondary)', 'Overall student satisfaction (secondary)', 'Application Rate', 'Retention Rate', 'Completion Rate (Secondary)'], email: '', photoUrl: '../photos/digital/jacob-adams.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQA4Z3GLmjrRQ7VQBp_tH6EAAX8tlXHJ79We6G8lvZI-Z_s?e=hfmBx2' },
  ...
  { id: 'brad-lester', name: 'Brad Lester', title: 'General Support Manager', dept: 'records', level: 3, status: 'FTE', reportsTo: 'mark-gefrom',
    ...
    kpis: ['Student support budget', 'Autonomy rate for student support cases'], email: '', photoUrl: '../photos/records/brad-lester.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQCKoBX4HbZJRq7HLLXdBrCbAdvXS8PLZF0W8t-imhz4UV4?e=HLCnTw' },
  ...
  { id: 'matthew-smith', name: 'Matthew Smith', title: 'Technical Support Manager', dept: 'records', level: 3, status: 'FTE', reportsTo: 'mark-gefrom',
    ...
    kpis: ['Tech support case resolution rate', 'Tech support costs', 'Autonomy rate for tech support cases'], email: '', photoUrl: '../photos/records/matthew-smith.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQC6ZURvjEf_R4kbBaAAgIjGAaB-PHWFt8Afm--cDEFlV6M?e=Y0g1Xo' },
  { id: 'hilary-bagley', name: 'Hilary Bagley', title: 'Student Experience Coordinator', dept: 'records', level: 4, status: 'FTE', reportsTo: 'brad-lester',
    ...
    kpis: ['Request-to-KB publish rate', 'Knowledge Base audit pass rate', 'Cost per KB Article Maintained', 'QA feedback cycle rate', 'QA calibration consistency rate', 'QA team lead feedback success rate', 'Cost per QA Evaluation'], email: '', photoUrl: '../photos/records/hilary-bagley.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAAwTC8MOIqQIkj0G04BRqGAc9Y9taAUl9NY_6ZfIDUJ4Y?e=hfFaGg' },
  ...
  { id: 'tyson-bell', name: 'Tyson Bell', title: 'Associate Registrar (Transcripts & Graduation)', dept: 'records', level: 4, status: 'FTE', reportsTo: 'kari-johnson',
    ...
    kpis: ['Records case resolution rate, QA, and CSAT'], email: '', photoUrl: '../photos/records/tyson-bell.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQANGB82vwVpR7kWikzK32R6AcXDcnbDlXCI-F8G8MsOwZA?e=HYUBCa' },
  // Level 5
  { id: 'colby-warner', name: 'Colby Warner', title: 'Product Support Engineer', dept: 'records', level: 5, status: 'FTE', reportsTo: 'matthew-smith',
    ...
    kpis: ['Escalated case resolution rate', 'Tech support case QA, CSAT, first contract resolution'], email: '', photoUrl: '../photos/records/colby-warner.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQBaWG5YlOnKQrXGueyhBughAXBMduY1rLTdPM_7EobPwQo?e=e6Zd8q' },
  { id: 'alyssa-burrell', name: 'Alyssa Burrell', title: 'Student Support Coordinator (Phone Support)', dept: 'records', level: 5, status: 'FTE', reportsTo: 'brad-lester',
    ...
    kpis: ['General support case response and resolution rates', 'Phone support answer speed, handle rate, agent availability, QA, CSAT, and first contact resolution'], email: '', photoUrl: '../photos/records/alyssa-burrell.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQBwUBFZyWZaSLXU28SQe4_cAUirTYoW8S2Th63JomM1XhM?e=YVQEeX' },
  { id: 'kira-hayes', name: 'Kira Hayes', title: 'Consistency Coordinator (QA & Knowledge Base)', dept: 'records', level: 5, status: 'FTE', reportsTo: 'brad-lester',
    ...
    kpis: ['KB publishing rate', 'QA evaluation completion rate', 'DSAT and critical violation delivery rate'], email: '', photoUrl: '../photos/records/kira-hayes.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQCtk6Visur9S73CLrYxUHrpAd25rc-Xrtvfnt3SO0KwFLM?e=H5naai' },
  { id: 'geraldine-bean', name: 'Geraldine Susan Bean', title: 'Graduation Coordinator', dept: 'records', level: 5, status: 'FTE', reportsTo: 'tyson-bell',
    ...
    kpis: ['Graduation application case completion rate', 'Award processing rate', 'Number of rescinded degrees', 'Application and awarding QA'], email: '', photoUrl: '../photos/records/geraldine-bean.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAR8feRUQUqRbS9IFJkfhY6Ae-dI_3KnvPYc7_B5RaXvmE?e=SVgmsJ' },
  { id: 'anne-owen', name: 'Anne E. Owen', title: 'Records & Transcript Coordinator', dept: 'records', level: 5, status: 'FTE', reportsTo: 'tyson-bell',
    ...
    kpis: ['Process case completion rate', 'Process case QA, and CSAT', 'Transcript accuracy QA'], email: '', photoUrl: '../photos/records/anne-owen.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAEOXkjnBS2T5AgKHhw-KlEAXws8SAXw2fBBXWANGQ3-i8?e=frYZ29' },
  { id: 'cindi-putnam', name: 'Cindi C Putnam', title: 'Planning Coordinator', dept: 'records', level: 5, status: 'FTE', reportsTo: 'kim-overdiek',
    ...
    kpis: ['Degree planning escalation case resolution rate, QA, and CSAT'], email: '', photoUrl: '../photos/records/cindi-putnam.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQDM5kWdtj6eTobfhfYTnaukATgc2h46N2asN0nMbPnj9eA?e=vikaN5' },
  { id: 'nikki-chambers', name: 'Nikki Jane Chambers', title: 'Enrollment Verification Specialist', dept: 'records', level: 5, status: 'FTT', reportsTo: 'kim-overdiek',
    ...
    kpis: ['Enrollment verification and apostille completion rate', 'Enrollment verification QA, and CSAT', 'Apostille QA, and CSAT'], email: '', photoUrl: '../photos/records/nikki-chambers.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQBkohdpEKodQoL-ghZzzwCRAQKlxkR8j_9LVGL0oGq1t5Y?e=8brGcT' },
  ...
  { id: 'trevor-shelton', name: 'Trevor Shelton', title: 'Senior Manager of Enrollment Services', dept: 'enrollment', level: 3, status: 'FTE', reportsTo: 'alison-cundiff',
    ...
    kpis: ['Reduction of enrollment related support cases', 'Reduction of admissions tier 2 support cases'], email: '', photoUrl: '../photos/enrollment/trevor-shelton.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQCVmNuaOp68SKhTnf_tOoajAX5JqDNZE3skdK_YOh1zQOg?e=cIHUdp' },
  { id: 'kelley-richardson', name: 'Kelley Richardson', title: 'Mentoring Manager', dept: 'enrollment', level: 3, status: 'FTE', reportsTo: 'alison-cundiff',
    ...
    kpis: ['Mentor required action completion rate', 'Mentor interaction QA', 'Overall student autonomy (secondary)', 'Mentor CSAT', 'Retention rate contribution by mentors'], email: '', photoUrl: '../photos/enrollment/kelley-richardson.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQDf11sIFIdKRpf47WFm_HrbAbXK5oADRJG7VjwmaQKoGEY?e=LfYtXd' },
  // Level 4
  { id: 'rachel-kirk', name: 'Rachel Kirk', title: 'Enrollment Counseling Manager', dept: 'enrollment', level: 4, status: 'FTE', reportsTo: 'trevor-shelton',
    ...
    kpis: ['Application start to admission yield', 'Admission to registration yield', 'Registration to auto-drop yield'], email: '', photoUrl: '../photos/enrollment/rachel-kirk.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAw0JzSy0-_SJwGTk9TEoL5AfQPAV9g6j-Z3Q3eUX_PAaY?e=flOOTM' },
  // Level 5
  ...
  { id: 'kimarie-howard', name: 'Kimarie Howard', title: 'Enrollment Counseling Development & Performance Coordinator', dept: 'enrollment', level: 5, status: 'Contractor', reportsTo: 'rachel-kirk',
    ...
    kpis: ['Enrollment Counseling CSAT rate', 'Enrollment Counseling yield contribution'], email: '', photoUrl: '../photos/enrollment/kimarie-howard.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQC8A6J14ltYSax9jMGUoFVTAec5lePpVzxNpeJdiJsbtBY?e=jimf3o' },
  { id: 'megan-niblett', name: 'Megan Niblett', title: 'Enrollment Counseling Operations Coordinator', dept: 'enrollment', level: 5, status: 'Contractor', reportsTo: 'rachel-kirk',
    ...
    kpis: ['Enrollment Counseling required action completion rate', 'Enrollment Counseling contact rate by alert'], email: '', photoUrl: '../photos/enrollment/megan-niblett.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQDYXALjqBy9TqMnkrLzZPALAVRIDVcR-t2zQ7_N6t_-sFI?e=OrqQzO' },
  { id: 'shaunasee-james', name: 'Shaunasee Janette James', title: 'Enrollment Coordinator', dept: 'enrollment', level: 5, status: 'FTE', reportsTo: 'trevor-shelton',
    ...
    kpis: ['Transfer evaluation processing rate', 'Number of transfer evaluation and endorsement cases', 'Transfer evaluation and endorsement case resolution rate'], email: '', photoUrl: '../photos/enrollment/shaunasee-james.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQBHJEF4d22UQ4TOTp6j8queASopK9ehmaq4-SfVdUQwo1g?e=qSPQFY' },
  ...
  { id: 'anne-clark', name: 'Anne Marie Clark', title: 'Associate Dean of Students', dept: 'dean', level: 3, status: 'FTE', reportsTo: 'steven-thomas',
    ...
    kpis: ['Dean of Students response and resolution time', 'Dean of Students services escalation rates', 'Partner C-Sat'], email: '', photoUrl: '../photos/dean/anne-clark.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQDSHzYkaQbiTKka4BszvUdeAelcwMltNNhbDXOi0SkDl08?e=xKEuAg' },
  ...
  { id: 'katelyn-ray', name: 'Katelyn Ray', title: 'Student Honor & Conduct Coordinator', dept: 'dean', level: 5, status: 'FTE', reportsTo: 'anne-clark',
    ...
    kpis: ['Honor and Conduct response and resolution time', 'Repeat offender rate'], email: '', photoUrl: '../photos/dean/katelyn-ray.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQBQz2AWfHg4QLr-tLfqWB5OAfGlKm815bIjKlysE6sH3XU?e=12zTcP' },
  { id: 'sandra-wirttele', name: 'Sandra Wurttele', title: 'Accessibility Office Coordinator', dept: 'dean', level: 5, status: 'Contractor', reportsTo: 'anne-clark',
    ...
    kpis: ['Accommodation determination processing and resolution rates', 'ADA and Section 504 standard compliance and audit compliance rates'], email: '', photoUrl: '../photos/dean/sandra-wirttele.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQBVF-cnaza5S4QpkfqcBzYBAeYcEuv3-9UQF2FsOVwDveg?e=fgld8E' },
  { id: 'ana-decastro', name: 'Ana De Castro', title: 'Office of Belonging Coordinator', dept: 'dean', level: 5, status: 'Contractor', reportsTo: 'anne-clark',
    ...
    kpis: ['Discrimination case resolution rate', 'Student sentiment on belonging', 'Student belonging CSAT'], email: '', photoUrl: '../photos/dean/ana-decastro.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQDw3EYyUChUSY3A6NON-yzTAbsZyYTV79vgs6HuVXn3KPM?e=eMTFQX' },
  { id: 'helen-reboucas', name: 'Helen Reboucas', title: 'Student Grievance Coordinator', dept: 'dean', level: 5, status: 'Contractor', reportsTo: 'anne-clark',
    ...
    kpis: ['Student grievance case resolution time', 'Grievance QA'], email: '', photoUrl: '../photos/dean/helen-reboucas.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAFWmgwRzlyR5zv2gsq5azrAXc2nfbXRXsAR85GuTJ0Ykw?e=lLfV4e' },
  { id: 'joseph-bentum', name: 'Joseph Bentum', title: 'Student Crisis Office Coordinator', dept: 'dean', level: 5, status: 'Contractor', reportsTo: 'anne-clark',
    ...
    kpis: ['Crisis response time'], email: '', photoUrl: '../photos/dean/joseph-bentum.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQCck7nWiNmJTbKblCL9bvWxASpttHquDaszNgyjwEDUvDA?e=zFBhpM' },
  ...
  { id: 'ricky-kailiponi', name: 'Ricky Kailiponi Jr.', title: 'Senior Manager of Digital Operations', dept: 'digital', level: 3, status: 'FTE', reportsTo: 'jacob-adams',
    ...
    kpis: ['Team meeting project deadlines', 'Companion feature C-Sat', 'Companion usage rates', 'Companion C-Sat', 'AI retention effect'], email: '', photoUrl: '../photos/digital/ricky-kailiponi.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQA_Pg4UzvhTS7QJCBFKoz33AfnpJQE-bSz0L_2WnenPqRk?e=fV14kS' },
  // Level 4
  { id: 'joshua-hadden', name: 'Joshua Stafford Hadden', title: 'System & Operations Manager', dept: 'digital', level: 3, status: 'FTE', reportsTo: 'jacob-adams',
    ...
    kpis: ['Team meeting project timelines rate', 'Stakeholder CSAT on team\'s projects', 'Cost reductions in service areas (secondary)'], email: '', photoUrl: '../photos/digital/joshua-hadden.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQDAfxv5-z3nRIuCZ8cuqVLrAetuZhsS26bV2B5GVKjLtkk?e=we7VuH' },
  { id: 'sebastian-vargas', name: 'Sebastian Vargas', title: 'D365 & Automation Dev. Manager', dept: 'digital', level: 4, status: 'Contractor', reportsTo: 'ricky-kailiponi',
    ...
    kpis: ['Stakeholder CSAT - timeliness per project', 'Stakeholder CSAT - communication, quality of work, impact'], email: '', photoUrl: '../photos/digital/sebastian-vargas.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQCJXq3iu29QSbfipK9hj10LAboUgNxbbxhiZixIQKvTths?e=d8h5fW' },
  { id: 'samuel-riveros', name: 'Samuel Riveros', title: 'Companion & Special Projects Dev. Manager', dept: 'digital', level: 4, status: 'Contractor', reportsTo: 'ricky-kailiponi',
    ...
    kpis: ['Stakeholder CSAT - timeliness per project', 'Stakeholder CSAT - communication, quality of work, impact'], email: '', photoUrl: '../photos/digital/samuel-riveros.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAGDpuAcq_uRJQfBo6jtQ6VAZzICKfHCBKlonY8DuoA5c0?e=uOPRI1' },
  { id: 'aitana-toscano', name: 'Aitana Toscano', title: 'Data Manager', dept: 'digital', level: 4, status: 'Contractor', reportsTo: 'ricky-kailiponi',
    ...
    kpis: ['Stakeholder CSAT - timeliness per project', 'Stakeholder CSAT - communication, quality of work, impact'], email: '', photoUrl: '../photos/digital/aitana-toscano.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQDM61NrXoIgTZn7hTXqXYRFAT-HAogly8tB9cq40Uvl0dk?e=9icL1c' },
  { id: 'isaias-zuniga', name: 'Isaias Zu\u00f1iga', title: 'AI Dev. Manager', dept: 'digital', level: 4, status: 'Contractor', reportsTo: 'ricky-kailiponi',
    ...
    kpis: [], email: '', photoUrl: '../photos/digital/isaias-zuniga.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQB-HCg_VNVVQ6goimpZTa7rAZp194qZhHI9tyf41DYA3T4?e=9YCbey' },
  // Level 5
  { id: 'david-peck', name: 'David Peck', title: 'Operational Data Analyst', dept: 'digital', level: 5, status: 'FTE', reportsTo: 'joshua-hadden',
    ...
    kpis: ['Project delivery on time rate', 'Stakeholder CSAT - communication, quality of work, impact'], email: '', photoUrl: '../photos/digital/david-peck.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQCZBbLkMAvERrRvFUiNIP8uAUhqA7Wc7H1tIJ0WisHWbLY?e=RulDks' },
  { id: 'pelenatita-neiufi', name: 'Pelenatita Neiufi', title: 'Reporting & Evaluation Coordinator', dept: 'digital', level: 5, status: 'FTE', reportsTo: 'joshua-hadden',
    ...
    kpis: ['Project delivery on time rate', 'Stakeholder CSAT - communication, quality of work, impact'], email: '', photoUrl: '../photos/digital/pelenatita-neiufi.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQDO92S10jkTS7uQSURJg-AQAQB0pMN-87vTcDEJaGIc7Y8?e=m2YL0Q' },
  { id: 'victor-ferreira', name: 'Victor Lam\u00e9ni Calado Ferreira', title: 'System & Operations Associate Registrar', dept: 'digital', level: 5, status: 'FTE', reportsTo: 'joshua-hadden',
    ...
    kpis: ['Project delivery on time rate', 'Stakeholder CSAT - communication, quality of work, impact'], email: '', photoUrl: '../photos/digital/victor-ferreira.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQBd6L0FnQgkQoq21Rr5e_CeAVnmrAepKNqoBsDZpFYsz3A?e=5EPfTL' },
  ...
  { id: 'jess-swinburne', name: 'Jess Swinburne', title: 'Project Manager', dept: 'executive', level: 2, status: 'Contractor', reportsTo: 'vp', role: 'pm', pmPosition: 'right',
    ...
    kpis: ['On-time delivery of cross-departmental projects', 'Stakeholder satisfaction with project communication and reporting', 'Resource utilization efficiency across initiatives'], email: '', photoUrl: '../photos/executive/jess-swinburne.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAmevpt63HgTreXjEGL0M9EAdyu6hNqyeGnyn7WtrmFhic?e=7CZh4x' },
  { id: 'david-koomson', name: 'David De-Graft Koomson', title: 'Assistant Project Manager', dept: 'executive', level: 2, status: 'Contractor', reportsTo: 'jess-swinburne', role: 'pm', pmPosition: 'right',
    ...
    kpis: ['Action item completion rate across VP initiatives', 'Meeting cadence adherence and documentation quality', 'Timely escalation of project risks and blockers'], email: '', photoUrl: '../photos/executive/david-koomson.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAmevpt63HgTreXjEGL0M9EAdyu6hNqyeGnyn7WtrmFhic?e=7CZh4x' },
  { id: 'victor-elerunndu', name: 'Victor Oluwapelumi Elerunndu', title: 'Project Manager', dept: 'records', level: 3, status: 'Contractor', reportsTo: 'mark-gefrom', role: 'pm', pmPosition: 'left',
    ...
    kpis: ['On-time delivery of student support projects', 'Project milestone completion rate', 'Stakeholder satisfaction with project communication'], email: '', photoUrl: '../photos/records/victor-elerunndu.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAmevpt63HgTreXjEGL0M9EAdyu6hNqyeGnyn7WtrmFhic?e=7CZh4x' },
  { id: 'moses-abioye', name: 'Moses Abioye', title: 'Project Manager', dept: 'records', level: 3, status: 'Contractor', reportsTo: 'mark-gefrom', role: 'pm', pmPosition: 'right',
    ...
    kpis: ['On-time delivery of registrar and records projects', 'Registration process improvement milestones met', 'Project documentation completeness and accuracy'], email: '', photoUrl: '../photos/records/moses-abioye.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAmevpt63HgTreXjEGL0M9EAdyu6hNqyeGnyn7WtrmFhic?e=7CZh4x' },
  { id: 'james-etukudo', name: 'James Etukudo Jr.', title: 'Project Manager', dept: 'enrollment', level: 3, status: 'Contractor', reportsTo: 'alison-cundiff', role: 'pm', pmPosition: 'right',
    ...
    kpis: ['On-time delivery of enrollment and retention projects', 'Enrollment initiative milestone completion rate', 'Stakeholder satisfaction with project updates and communication'], email: '', photoUrl: '../photos/enrollment/james-etukudo.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAmevpt63HgTreXjEGL0M9EAdyu6hNqyeGnyn7WtrmFhic?e=7CZh4x' },
