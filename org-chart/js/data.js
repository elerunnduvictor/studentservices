...
OC.employees = [
  ...
  { id: 'mark-gefrom', name: 'Mark Gefrom', title: 'Director of Student Records, Registration & Support', dept: 'records', level: 2, status: 'FTE', reportsTo: 'vp',
    ...
    kpis: ['Student support ticket resolution rates', 'Help Center usage and effectiveness', 'Overall department satisfaction scores'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'alison-cundiff', name: 'Alison Cundiff', title: 'Director of Enrollment & Retention', dept: 'enrollment', level: 2, status: 'FTE', reportsTo: 'vp',
    ...
    kpis: ['Enrollment & Retention budget management', 'Application, retention, and completion rates', 'Overall student autonomy and satisfaction (secondary)'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'steven-thomas', name: 'Steven K. Thomas', title: 'Dean of Students', dept: 'dean', level: 2, status: 'FTE', reportsTo: 'vp',
    ...
    kpis: ['No material audit, legal, or accreditation findings attributable to DOS', 'Annual DOS budget management', 'Overall student satisfaction (primary)'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'jacob-adams', name: 'Jacob Adams', title: 'Director of Digital Operations', dept: 'digital', level: 2, status: 'FTE', reportsTo: 'vp',
    ...
    kpis: ['Stakeholder CSAT with timeliness per project', 'Stakeholder CSAT with communication and roadmap', 'Overall student autonomy and satisfaction (secondary)'], email: '', photoUrl: '', roleInventoryUrl: '' },
  ...
  { id: 'brad-lester', name: 'Brad Lester', title: 'Senior Manager of Student Support', dept: 'records', level: 3, status: 'FTE', reportsTo: 'mark-gefrom',
    ...
    kpis: ['Ticket response and resolution times', 'QA, CSAT, and FCR scores', 'Student support budget management'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'kari-johnson', name: 'Kari Johnson', title: 'Registrar', dept: 'records', level: 3, status: 'FTE', reportsTo: 'mark-gefrom',
    ...
    kpis: ['Resolution time on Registrar processes and tickets', 'C-Sat on Registrar processes and tickets', 'Registrar budget management'], email: '', photoUrl: '', roleInventoryUrl: '' },
  // Level 4
  { id: 'matthew-smith', name: 'Matthew Smith', title: 'Technical Support Manager', dept: 'records', level: 4, status: 'FTE', reportsTo: 'brad-lester',
    ...
    kpis: ['Tech support ticket resolution time', 'Tech support QA, CSAT, and FCR scores', 'Tech support costs'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'hilary-bagley', name: 'Hilary Bagley', title: 'Training & QA Manager', dept: 'records', level: 4, status: 'FTE', reportsTo: 'brad-lester',
    ...
    kpis: ['Request-to-KB Publish Time (median days)', 'QA Calibration Consistency Rate', 'KB Audit accuracy scores'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'kim-overdiek', name: 'Kim Overdiek', title: 'Associate Registrar', dept: 'records', level: 4, status: 'FTE', reportsTo: 'kari-johnson',
    ...
    kpis: ['Ticket resolution time', 'On-time catalog publishing and system configuration', 'Planning and Registration team costs'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'tyson-bell', name: 'Tyson Bell', title: 'Associate Registrar', dept: 'records', level: 4, status: 'FTE', reportsTo: 'kari-johnson',
    ...
    kpis: ['Student records accuracy rate', 'Transcript processing time', 'Graduation verification accuracy'], email: '', photoUrl: '', roleInventoryUrl: '' },
  // Level 5
  { id: 'colby-warner', name: 'Colby Warner', title: 'Product Support Engineer', dept: 'records', level: 5, status: 'FTE', reportsTo: 'matthew-smith',
    ...
    kpis: ['Individual ticket resolution time', 'Ticket response time', 'Tech Support QA, CSAT, and FCR scores'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'alyssa-burrell', name: 'Alyssa Burrell', title: 'Student Support Coordinator', dept: 'records', level: 5, status: 'FTE', reportsTo: 'brad-lester',
    ...
    kpis: ['Phone answer speed and handle time', 'Phone Support QA, CSAT, and FCR scores', 'Phone support cost management'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'kira-hayes', name: 'Kira Hayes', title: 'Training & QA Coordinator', dept: 'records', level: 5, status: 'FTE', reportsTo: 'hilary-bagley',
    ...
    kpis: ['KB publishing time', 'QA evaluations on every agent', 'All DSAT & Critical Violations sent to team leaders'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'geraldine-bean', name: 'Geraldine Susan Bean', title: 'Graduation Coordinator', dept: 'records', level: 5, status: 'FTE', reportsTo: 'tyson-bell',
    ...
    kpis: ['Graduation application completion time', 'Number of rescinded degrees', 'Graduation team costs'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'anne-owen', name: 'Anne E. Owen', title: 'Records & Transcript Coordinator', dept: 'records', level: 5, status: 'FTE', reportsTo: 'tyson-bell',
    ...
    kpis: ['Process ticket completion time', 'Transcript accuracy QA scores', 'Process ticket C-Sat'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'cindi-putnam', name: 'Cindi C Putnam', title: 'Planning Coordinator', dept: 'records', level: 5, status: 'FTE', reportsTo: 'kim-overdiek',
    ...
    kpis: ['Degree planning escalation ticket resolution time', 'Degree planning escalation ticket C-Sat and QA', 'Degree planning team costs'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'nikki-chambers', name: 'Nikki Jane Chambers', title: 'Enrollment Verification Specialist', dept: 'records', level: 5, status: 'FTT', reportsTo: 'tyson-bell',
    ...
    kpis: ['Enrollment verification completion time', 'Apostille QA and C-Sat', 'Enrollment Verification team costs'], email: '', photoUrl: '', roleInventoryUrl: '' },
  ...
  { id: 'trevor-shelton', name: 'Trevor Shelton', title: 'Senior Manager of Enrollment Services', dept: 'enrollment', level: 3, status: 'FTE', reportsTo: 'alison-cundiff',
    ...
    kpis: ['Delivery of strategic admissions initiatives on time and as scoped', '% reduction of enrollment related support tickets', '% reduction of admissions tier 2 support tickets'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'kelley-richardson', name: 'Kelley Richardson', title: 'Mentoring Manager', dept: 'enrollment', level: 3, status: 'FTE', reportsTo: 'alison-cundiff',
    ...
    kpis: ['Mentor RA Completion Rates', 'Mentor Interaction QA Rates', 'Mentor CSAT rates'], email: '', photoUrl: '', roleInventoryUrl: '' },
  // Level 4
  { id: 'rachel-kirk', name: 'Rachel Kirk', title: 'Enrollment Counseling Manager', dept: 'enrollment', level: 4, status: 'FTE', reportsTo: 'trevor-shelton',
    ...
    kpis: ['EC RA Completion Rates', 'EC Contact rate by alert', 'Yield contribution by EC'], email: '', photoUrl: '', roleInventoryUrl: '' },
  // Level 5
  { id: 'mandy-schwab', name: 'Mandy Schwab', title: 'Mentor Development Specialist', dept: 'enrollment', level: 5, status: 'PTT', reportsTo: 'kelley-richardson',
    ...
    kpis: ['Mentor Interaction QA Rates', 'Mentor CSAT rates'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'johanna-relkin', name: 'Johanna Relkin', title: 'Mentor Operations Specialist', dept: 'enrollment', level: 5, status: 'PTT', reportsTo: 'kelley-richardson',
    ...
    kpis: ['Mentor RA Completion Rates'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'kimarie-howard', name: 'Kimarie Howard', title: 'EC Development & Performance Coordinator', dept: 'enrollment', level: 5, status: 'Contractor', reportsTo: 'rachel-kirk',
    ...
    kpis: ['EC CSAT rates', 'Yield contribution by EC'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'megan-niblett', name: 'Megan Niblett', title: 'EC Operations Coordinator', dept: 'enrollment', level: 5, status: 'Contractor', reportsTo: 'rachel-kirk',
    ...
    kpis: ['EC RA Completion Rates', 'EC Contact rate by alert', 'EC CSAT rates'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'shaunasee-james', name: 'Shaunasee Janette James', title: 'Enrollment Coordinator', dept: 'enrollment', level: 5, status: 'FTE', reportsTo: 'trevor-shelton',
    ...
    kpis: ['Transfer Evaluation Throughput rate', 'Transfer Eval timelines (case age rates)', 'Transfer Eval quality (QA scores)'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'ely-zmolek', name: 'Ely Zmolek', title: 'Enrollment Services Specialist', dept: 'enrollment', level: 5, status: 'FTE', reportsTo: 'trevor-shelton',
    ...
    kpis: ['% of applications processed within 1 business day during promotion', 'Manual review turnaround time (within one week)', 'Reduction of application related support tickets'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'trey-mooney', name: 'Trey Mooney', title: 'University Chaplain', dept: 'enrollment', level: 5, status: 'FTE', reportsTo: 'trevor-shelton',
    ...
    kpis: ['Endorsement completion time', '% of positive feedback from missionary chaplains', '% of non-member student grievances related to endorsement delays'], email: '', photoUrl: '', roleInventoryUrl: '' },
  ...
  { id: 'anne-clark', name: 'Anne Marie Clark', title: 'Associate Dean of Students', dept: 'dean', level: 3, status: 'FTE', reportsTo: 'steven-thomas',
    ...
    kpis: ['DOS case response and resolution times', 'Low escalation rates across DOS service areas', 'Deputy Title IX and ADA/Section 504 Coordinator metrics'], email: '', photoUrl: '', roleInventoryUrl: '' },
  ...
  { id: 'katelyn-ray', name: 'Katelyn Ray', title: 'Student Honor & Conduct Coordinator', dept: 'dean', level: 5, status: 'FTE', reportsTo: 'anne-clark',
    ...
    kpis: ['Honor and Conduct cases response and resolution times', 'Rate of repeat offenders'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'sandra-wirttele', name: 'Sandra Wirttele', title: 'Student Accessibility Coordinator', dept: 'dean', level: 5, status: 'Contractor', reportsTo: 'anne-clark',
    ...
    kpis: ['Accommodation determinations and resolution times', 'Compliance with ADA and Section 504 standards audit'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'ana-decastro', name: 'Ana De Castro', title: 'Student Belonging Coordinator', dept: 'dean', level: 5, status: 'Contractor', reportsTo: 'anne-clark',
    ...
    kpis: ['Discrimination concerns resolved informally without escalation', 'Student sentiment and C-Sat surveys'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'helen-reboucas', name: 'Helen Reboucas', title: 'Student Grievance Coordinator', dept: 'dean', level: 5, status: 'Contractor', reportsTo: 'anne-clark',
    ...
    kpis: ['Student grievance case resolution time', 'Grievance QA scores'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'joseph-bentum', name: 'Joseph Bentum', title: 'Student Crisis Coordinator', dept: 'dean', level: 5, status: 'Contractor', reportsTo: 'anne-clark',
    ...
    kpis: ['Crisis response time', 'Appropriate C-Sat or QA measures for crisis resolution'], email: '', photoUrl: '', roleInventoryUrl: '' },
  ...
  { id: 'ricky-kailiponi', name: 'Ricky Kailiponi Jr.', title: 'Senior Manager of Digital Operations', dept: 'digital', level: 3, status: 'FTE', reportsTo: 'jacob-adams',
    ...
    kpis: ['Stakeholder CSAT with timeliness per project', '% student autonomy through AI outreach (partnership metric)'], email: '', photoUrl: '', roleInventoryUrl: '' },
  // Level 4
  { id: 'joshua-hadden', name: 'Joshua Stafford Hadden', title: 'System & Operations Manager', dept: 'digital', level: 4, status: 'FTE', reportsTo: 'ricky-kailiponi',
    ...
    kpis: ['Time to graduation/transcript requests completion', 'Projects delivered ahead or before schedule', 'Stakeholder CSAT with system operations'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'sebastian-vargas', name: 'Sebastian Vargas', title: 'Dev Manager', dept: 'digital', level: 4, status: 'Contractor', reportsTo: 'ricky-kailiponi',
    ...
    kpis: ['Stakeholder CSAT with timeliness and quality', 'Stakeholder CSAT with communication and roadmap', 'Data analyst costs per PowerBI project'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'samuel-riveros', name: 'Samuel Riveros', title: 'Dev Manager', dept: 'digital', level: 4, status: 'Contractor', reportsTo: 'ricky-kailiponi',
    ...
    kpis: ['Companion front-end stability metrics', 'Analytics engine integration quality', 'Stakeholder CSAT with development delivery'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'aitana-toscano', name: 'Aitana Toscano', title: 'Dev Manager', dept: 'digital', level: 4, status: 'Contractor', reportsTo: 'ricky-kailiponi',
    ...
    kpis: ['Power BI turnaround time', 'Backend table stability metrics', 'Stakeholder CSAT with data quality'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'isaias-zuniga', name: 'Isaias Zu\u00f1iga', title: 'AI Manager', dept: 'digital', level: 4, status: 'Contractor', reportsTo: 'ricky-kailiponi',
    ...
    kpis: ['Azure DevOps sprint completion rates', 'Model drift and silent hallucination monitoring', 'Developer costs per project'], email: '', photoUrl: '', roleInventoryUrl: '' },
  // Level 5
  { id: 'david-peck', name: 'David Peck', title: 'Operational Data Analyst', dept: 'digital', level: 5, status: 'FTE', reportsTo: 'joshua-hadden',
    ...
    kpis: ['Stakeholder CSAT with timeliness per project', 'Report accuracy and refresh reliability'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'pelenatita-neiufi', name: 'Pelenatita Neiufi', title: 'Reporting & Evaluation Coordinator', dept: 'digital', level: 5, status: 'FTE', reportsTo: 'joshua-hadden',
    ...
    kpis: ['Stakeholder CSAT with communication and roadmap', 'Reporting accuracy and timeliness'], email: '', photoUrl: '', roleInventoryUrl: '' },
  { id: 'victor-ferreira', name: 'Victor Lam\u00e9ni Calado Ferreira', title: 'System & Operations Associate Registrar', dept: 'digital', level: 5, status: 'FTE', reportsTo: 'joshua-hadden',
    ...
    kpis: ['SIS uptime and reliability', 'FERPA compliance audit results', 'Academic policy implementation accuracy'], email: '', photoUrl: '', roleInventoryUrl: '' },
  ...
  { id: 'david-koomson', name: 'David De-Graft Koomson', title: 'Assistant Project Manager', dept: 'executive', level: 2, status: 'Contractor', reportsTo: 'vp', role: 'pm', pmPosition: 'right',
