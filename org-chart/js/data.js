...
OC.employees = [
  ...
  { id: 'vp', name: 'Ben Packer', title: 'Vice President of Student Services', dept: 'executive', level: 1, status: 'FTE', reportsTo: null,
    ...
    kpis: ['Overall student satisfaction scores', 'Student retention and completion rates', 'Operational efficiency across departments'], email: 'bpacker@byupw.edu', photoUrl: '../photos/executive/vp.jpeg' },
  ...
  { id: 'alison-cundiff', name: 'Alison Cundiff', title: 'Director of Enrollment & Retention', dept: 'enrollment', level: 2, status: 'FTE', reportsTo: 'vp',
    ...
    kpis: ['Enrollment & Retention budget', 'Enrollment, retention, completion (primary)', 'Overall student autonomy and satisfaction (secondary)'], email: 'acundiff@byupw.edu', photoUrl: '../photos/enrollment/alison-cundiff.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAFhc5UkuwgTapnxWheHmYRAeUt6L6jGcomm-gS_hKDWbg?e=v2NPg4' },
  { id: 'steven-thomas', name: 'Steven K. Thomas', title: 'Dean of Students', dept: 'dean', level: 2, status: 'FTE', reportsTo: 'vp',
    ...
    kpis: ['No material audit, legal, or accreditation findings attributable to Dean of Students governance', 'Annual DOS budget', 'Overall student satisfaction (primary)'], email: 'sthomas@byupw.edu', photoUrl: '../photos/dean/steven-thomas.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAJCeQuk9fHTbFRX-_VINCFAXaStbvWN2DK4_tsSELnmmQ?e=UfES01' },
  { id: 'jacob-adams', name: 'Jacob Adams', title: 'Director of Digital Operations', dept: 'digital', level: 2, status: 'FTE', reportsTo: 'vp',
    ...
    kpis: ['Overall Stakeholder CSAT', 'Digital Ops budget', 'Costs saved by customers due to Digital Ops technologies (secondary)', 'Overall student autonomy (secondary)', 'Overall student satisfaction (secondary)', 'Application Rate', 'Retention Rate', 'Completion Rate (Secondary)'], email: 'jadams@byupw.edu', photoUrl: '../photos/digital/jacob-adams.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQA4Z3GLmjrRQ7VQBp_tH6EAAX8tlXHJ79We6G8lvZI-Z_s?e=hfmBx2' },
  ...
  { id: 'kari-johnson', name: 'Kari Johnson', title: 'Registrar', dept: 'records', level: 3, status: 'FTE', reportsTo: 'mark-gefrom',
    ...
    kpis: ['Registrar budget', 'Autonomy for registrar processes and cases', 'Case CSAT for planning and registration'], email: 'karijohnson32@byupw.edu', photoUrl: '../photos/records/kari-johnson.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQBkQUDPjDkJQqGJR2uD02GvAZ2F5T3reRUi0tmNHnatB8c?e=em7vc2' },
  { id: 'matthew-smith', name: 'Matthew Smith', title: 'Technical Support Manager', dept: 'records', level: 3, status: 'FTE', reportsTo: 'mark-gefrom',
    responsibilities: ['Inbound tech support lead'],
    kpis: ['Tech support case resolution rate', 'Tech support costs', 'Autonomy rate for tech support cases'], email: 'msmith@byupw.edu', photoUrl: '../photos/records/matthew-smith.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQC6ZURvjEf_R4kbBaAAgIjGAaB-PHWFt8Afm--cDEFlV6M?e=Y0g1Xo' },
  { id: 'hilary-bagley', name: 'Hilary Bagley', title: 'Student Experience Coordinator', dept: 'records', level: 4, status: 'FTE', reportsTo: 'brad-lester',
    ...
    kpis: ['Request-to-KB publish rate', 'Knowledge Base audit pass rate', 'Cost per KB Article Maintained', 'QA feedback cycle rate', 'QA calibration consistency rate', 'QA team lead feedback success rate', 'Cost per QA Evaluation'], email: 'hbagley@byupw.edu', photoUrl: '../photos/records/hilary-bagley.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAAwTC8MOIqQIkj0G04BRqGAc9Y9taAUl9NY_6ZfIDUJ4Y?e=hfFaGg' },
  { id: 'kim-overdiek', name: 'Kim Overdiek', title: 'Associate Registrar (Curriculum & Configuration)', dept: 'records', level: 4, status: 'FTE', reportsTo: 'kari-johnson',
    ...
    kpis: ['Process case resolution rate, QA, and CSAT', 'On-time catalog publishing and system configuration rates'], email: 'kim.overdiek@byupw.edu', photoUrl: '../photos/records/kim-overdiek.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQDHxfnyxJ_PTKTIYysDqssWAVj3YJCFsDb62MgYnRnRvfo?e=zcdOtl' },
  { id: 'tyson-bell', name: 'Tyson Bell', title: 'Associate Registrar (Transcripts & Graduation)', dept: 'records', level: 4, status: 'FTE', reportsTo: 'kari-johnson',
    responsibilities: ['Student records', 'Transcripts', 'Graduation', 'Enrollment verification'],
    kpis: ['Records case resolution rate, QA, and CSAT'], email: 'tbell1@byupw.edu', photoUrl: '../photos/records/tyson-bell.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQANGB82vwVpR7kWikzK32R6AcXDcnbDlXCI-F8G8MsOwZA?e=HYUBCa' },
  // Level 5
  { id: 'colby-warner', name: 'Colby Warner', title: 'Product Support Engineer', dept: 'records', level: 5, status: 'FTE', reportsTo: 'matthew-smith',
    ...
    kpis: ['Escalated case resolution rate', 'Tech support case QA, CSAT, first contract resolution'], email: 'CWarner@byupw.edu', photoUrl: '../photos/records/colby-warner.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQBaWG5YlOnKQrXGueyhBughAXBMduY1rLTdPM_7EobPwQo?e=e6Zd8q' },
  ...
  { id: 'angie-holt', name: 'Angie Holt', title: 'Graduation Coordinator', dept: 'records', level: 5, status: 'Contractor', reportsTo: 'tyson-bell',
    responsibilities: ['Graduation application', 'Diploma awarding process'],
    kpis: ['Graduation application case completion rate', 'Award processing rate', 'Number of rescinded degrees', 'Application and awarding QA'], email: 'angieholt@churchofjesuschrist.org', photoUrl: '../photos/records/angie-holt.jpg', roleInventoryUrl: '' },
  { id: 'anne-owen', name: 'Anne E. Owen', title: 'Records & Transcript Coordinator', dept: 'records', level: 5, status: 'FTE', reportsTo: 'tyson-bell',
    ...
    kpis: ['Process case completion rate', 'Process case QA, and CSAT', 'Transcript accuracy QA'], email: 'adavidso@byupw.edu', photoUrl: '../photos/records/anne-owen.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAEOXkjnBS2T5AgKHhw-KlEAXws8SAXw2fBBXWANGQ3-i8?e=frYZ29' },
  ...
  { id: 'daniel-zago', name: 'Daniel Zago', title: 'Curriculum and Registration Coordinator', dept: 'records', level: 5, status: 'Contractor', reportsTo: 'kim-overdiek',
    responsibilities: ['Curriculum/catalog maintenance', 'Course registration process support'],
    kpis: ['Catalog accuracy', 'Registration support case resolution rate'], email: 'danielnzago@churchofjesuschrist.org', photoUrl: '../photos/records/daniel-zago.jpg', roleInventoryUrl: '' },
  ...
  { id: 'rachel-kirk', name: 'Rachel Kirk', title: 'Enrollment Counseling Manager', dept: 'enrollment', level: 4, status: 'FTE', reportsTo: 'trevor-shelton',
    ...
    kpis: ['Application start to admission yield', 'Admission to registration yield', 'Registration to auto-drop yield'], email: 'Rhorton@byupw.edu', photoUrl: '../photos/enrollment/rachel-kirk.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAw0JzSy0-_SJwGTk9TEoL5AfQPAV9g6j-Z3Q3eUX_PAaY?e=flOOTM' },
  // Level 5
  { id: 'mandy-schwab', name: 'Mandy Schwab', title: 'Mentor Development Specialist', dept: 'enrollment', level: 5, status: 'PTT', reportsTo: 'kelley-richardson',
    ...
    kpis: ['Mentor interaction QA', 'Mentor CSAT'], email: 'Mandraps@byupw.edu', photoUrl: '../photos/enrollment/mandy-schwab.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQBy2LVzDoldRZisyIODLh8zAQMURc-jWPshlLW15i3qb1A?e=U7sRj2' },
  { id: 'johanna-relkin', name: 'Joanna Relken', title: 'Mentor Operations Specialist', dept: 'enrollment', level: 5, status: 'PTT', reportsTo: 'kelley-richardson',
    ...
    kpis: ['Mentor required action completion rate', 'Mentor concern case QA'], email: 'Joanna.Relken@byupw.edu', photoUrl: '../photos/enrollment/johanna-relkin.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAD6qmcBdXESLblm4Cwxcq-AQzexoG57ED2rJSulZnrW7A?e=istmOr' },
  { id: 'kimarie-howard', name: 'Kimarie Howard', title: 'Enrollment Counseling Development & Performance Coordinator', dept: 'enrollment', level: 5, status: 'Contractor', reportsTo: 'rachel-kirk',
    ...
    kpis: ['Enrollment Counseling CSAT rate', 'Enrollment Counseling yield contribution'], email: 'khoward@byupw.edu', photoUrl: '../photos/enrollment/kimarie-howard.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQC8A6J14ltYSax9jMGUoFVTAec5lePpVzxNpeJdiJsbtBY?e=jimf3o' },
  { id: 'megan-niblett', name: 'Megan Niblett', title: 'Enrollment Counseling Operations Coordinator', dept: 'enrollment', level: 5, status: 'Contractor', reportsTo: 'rachel-kirk',
    responsibilities: ['Enrollment Counseling operations'],
    kpis: ['Enrollment Counseling required action completion rate', 'Enrollment Counseling contact rate by alert'], email: 'megannicolebrown@byupw.edu', photoUrl: '../photos/enrollment/megan-niblett.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQDYXALjqBy9TqMnkrLzZPALAVRIDVcR-t2zQ7_N6t_-sFI?e=OrqQzO' },
  ...
  { id: 'anne-clark', name: 'Anne Marie Clark', title: 'Associate Dean of Students', dept: 'dean', level: 3, status: 'FTE', reportsTo: 'steven-thomas',
    ...
    kpis: ['Dean of Students response and resolution time', 'Dean of Students services escalation rates', 'Partner C-Sat'], email: 'aclark@byupw.edu', photoUrl: '../photos/dean/anne-clark.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQDSHzYkaQbiTKka4BszvUdeAelcwMltNNhbDXOi0SkDl08?e=xKEuAg' },
  ...
  { id: 'katelyn-ray', name: 'Katelyn Ray', title: 'Student Honor & Conduct Coordinator', dept: 'dean', level: 5, status: 'FTE', reportsTo: 'anne-clark',
    ...
    kpis: ['Honor and Conduct response and resolution time', 'Repeat offender rate'], email: 'KRay@byupw.edu', photoUrl: '../photos/dean/katelyn-ray.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQBQz2AWfHg4QLr-tLfqWB5OAfGlKm815bIjKlysE6sH3XU?e=12zTcP' },
  { id: 'sandra-wirttele', name: 'Sandra Wurttele', title: 'Accessibility Office Coordinator', dept: 'dean', level: 5, status: 'Contractor', reportsTo: 'anne-clark',
    ...
    kpis: ['Accommodation determination processing and resolution rates', 'ADA and Section 504 standard compliance and audit compliance rates'], email: 'sandrawurttele@byupw.edu', photoUrl: '../photos/dean/sandra-wirttele.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQBVF-cnaza5S4QpkfqcBzYBAeYcEuv3-9UQF2FsOVwDveg?e=fgld8E' },
  { id: 'ana-decastro', name: 'Ana De Castro', title: 'Office of Belonging Coordinator', dept: 'dean', level: 5, status: 'FTE', reportsTo: 'anne-clark',
    ...
    kpis: ['Discrimination case resolution rate', 'Student sentiment on belonging', 'Student belonging CSAT'], email: 'Ana.deCastro@byupw.edu', photoUrl: '../photos/dean/ana-decastro.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQDw3EYyUChUSY3A6NON-yzTAbsZyYTV79vgs6HuVXn3KPM?e=eMTFQX' },
  { id: 'helen-reboucas', name: 'Helen Reboucas', title: 'Student Grievance Coordinator', dept: 'dean', level: 5, status: 'Contractor', reportsTo: 'anne-clark',
    ...
    kpis: ['Student grievance case resolution time', 'Grievance QA'], email: 'Helen.Reboucas@churchofjesuschrist.org', photoUrl: '../photos/dean/helen-reboucas.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAFWmgwRzlyR5zv2gsq5azrAXc2nfbXRXsAR85GuTJ0Ykw?e=lLfV4e' },
  { id: 'joseph-bentum', name: 'Joseph Bentum', title: 'Student Crisis Office Coordinator', dept: 'dean', level: 5, status: 'Contractor', reportsTo: 'anne-clark',
    ...
    kpis: ['Crisis response time'], email: 'BentumJY@churchofjesuschrist.org', photoUrl: '../photos/dean/joseph-bentum.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQCck7nWiNmJTbKblCL9bvWxASpttHquDaszNgyjwEDUvDA?e=zFBhpM' },
  ...
  { id: 'ricky-kailiponi', name: 'Ricky Kailiponi Jr.', title: 'Senior Manager of Digital Operations', dept: 'digital', level: 3, status: 'FTE', reportsTo: 'jacob-adams',
    ...
    kpis: ['Team meeting project deadlines', 'Companion feature C-Sat', 'Companion usage rates', 'Companion C-Sat', 'AI retention effect'], email: 'rkailiponi@byupw.edu', photoUrl: '../photos/digital/ricky-kailiponi.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQA_Pg4UzvhTS7QJCBFKoz33AfnpJQE-bSz0L_2WnenPqRk?e=fV14kS' },
  // Level 4
  { id: 'joshua-hadden', name: 'Joshua Stafford Hadden', title: 'System & Operations Manager', dept: 'digital', level: 3, status: 'FTE', reportsTo: 'jacob-adams',
    ...
    kpis: ['Team meeting project timelines rate', 'Stakeholder CSAT on team\'s projects', 'Cost reductions in service areas (secondary)'], email: 'jhadden@byupw.edu', photoUrl: '../photos/digital/joshua-hadden.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQDAfxv5-z3nRIuCZ8cuqVLrAetuZhsS26bV2B5GVKjLtkk?e=we7VuH' },
  { id: 'sebastian-vargas', name: 'Sebastian Vargas', title: 'D365 & Automation Dev. Manager', dept: 'digital', level: 4, status: 'Contractor', reportsTo: 'ricky-kailiponi',
    responsibilities: ['Mentor Portal', 'Predictive Model Data Pipeline'],
    kpis: ['Stakeholder CSAT - timeliness per project', 'Stakeholder CSAT - communication, quality of work, impact'], email: 'sebastian.vargas@ChurchofJesusChrist.org', photoUrl: '../photos/digital/sebastian-vargas.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQCJXq3iu29QSbfipK9hj10LAboUgNxbbxhiZixIQKvTths?e=d8h5fW' },
  ...
  { id: 'isaias-zuniga', name: 'Isaias Zuñiga', title: 'AI Dev. Manager', dept: 'digital', level: 4, status: 'Contractor', reportsTo: 'ricky-kailiponi',
    ...
    kpis: [], email: 'izunigac@byupw.edu', photoUrl: '../photos/digital/isaias-zuniga.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQB-HCg_VNVVQ6goimpZTa7rAZp194qZhHI9tyf41DYA3T4?e=9YCbey' },
  // Level 5
  { id: 'david-peck', name: 'David Peck', title: 'Operational Data Analyst', dept: 'digital', level: 5, status: 'FTE', reportsTo: 'joshua-hadden',
    ...
    kpis: ['Project delivery on time rate', 'Stakeholder CSAT - communication, quality of work, impact'], email: 'dpeck@byupw.edu', photoUrl: '../photos/digital/david-peck.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQCZBbLkMAvERrRvFUiNIP8uAUhqA7Wc7H1tIJ0WisHWbLY?e=RulDks' },
  { id: 'pelenatita-neiufi', name: 'Pelenatita Neiufi', title: 'Reporting & Evaluation Coordinator', dept: 'digital', level: 5, status: 'FTE', reportsTo: 'joshua-hadden',
    ...
    kpis: ['Project delivery on time rate', 'Stakeholder CSAT - communication, quality of work, impact'], email: 'PNeiufi@byupw.edu', photoUrl: '../photos/digital/pelenatita-neiufi.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQDO92S10jkTS7uQSURJg-AQAQB0pMN-87vTcDEJaGIc7Y8?e=m2YL0Q' },
  ...
  { id: 'jess-swinburne', name: 'Jess Swinburne', title: 'Project Manager', dept: 'executive', level: 2, status: 'Contractor', reportsTo: 'vp', role: 'pm', pmPosition: 'right',
    ...
    kpis: ['On-time delivery of cross-departmental projects', 'Stakeholder satisfaction with project communication and reporting', 'Resource utilization efficiency across initiatives'], email: 'JSwinburne@churchofjesuschrist.org', photoUrl: '../photos/executive/jess-swinburne.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAmevpt63HgTreXjEGL0M9EAdyu6hNqyeGnyn7WtrmFhic?e=7CZh4x' },
  { id: 'gilles-mambou', name: 'Elie Gilles Ravel Mambou', title: 'Assistant Project Manager', dept: 'executive', level: 2, status: 'Contractor', reportsTo: 'jess-swinburne', role: 'pm', pmPosition: 'right',
    ...
    kpis: ['Action item completion rate across VP initiatives', 'Meeting cadence adherence and documentation quality', 'Timely escalation of project risks and blockers'], email: 'gillesravelmambou@churchofjesuschrist.org', photoUrl: '../photos/executive/gilles-mambou.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAmevpt63HgTreXjEGL0M9EAdyu6hNqyeGnyn7WtrmFhic?e=7CZh4x' },
  { id: 'david-koomson', name: 'David De-Graft Koomson', title: 'Project Manager', dept: 'digital', level: 3, status: 'Contractor', reportsTo: 'jacob-adams', role: 'pm', pmPosition: 'left',
    ...
    kpis: ['On-time delivery of digital operations projects', 'Sprint and release milestone completion rate', 'Stakeholder satisfaction with project timeliness and communication'], email: 'davidkoomson@churchofjesuschrist.org', photoUrl: '../photos/executive/david-koomson.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAmevpt63HgTreXjEGL0M9EAdyu6hNqyeGnyn7WtrmFhic?e=7CZh4x' },
  { id: 'victor-elerunndu', name: 'Victor Oluwapelumi Elerunndu', title: 'Project Manager', dept: 'records', level: 3, status: 'Contractor', reportsTo: 'mark-gefrom', role: 'pm', pmPosition: 'left',
    ...
    kpis: ['On-time delivery of student support projects', 'Project milestone completion rate', 'Stakeholder satisfaction with project communication'], email: 'oluwapelumi@churchofjesuschrist.org', photoUrl: '../photos/records/victor-elerunndu.jpg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAmevpt63HgTreXjEGL0M9EAdyu6hNqyeGnyn7WtrmFhic?e=7CZh4x' },
  { id: 'moses-abioye', name: 'Moses Abioye', title: 'Project Manager', dept: 'records', level: 3, status: 'Contractor', reportsTo: 'mark-gefrom', role: 'pm', pmPosition: 'right',
    ...
    kpis: ['On-time delivery of registrar and records projects', 'Registration process improvement milestones met', 'Project documentation completeness and accuracy'], email: 'MAbioye@churchofjesuschrist.org', photoUrl: '../photos/records/moses-abioye.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAmevpt63HgTreXjEGL0M9EAdyu6hNqyeGnyn7WtrmFhic?e=7CZh4x' },
  { id: 'charles-crankson', name: 'Charles Crankson', title: 'Project Manager', dept: 'enrollment', level: 3, status: 'Contractor', reportsTo: 'alison-cundiff', role: 'pm', pmPosition: 'right',
    ...
    kpis: ['On-time delivery of enrollment and retention projects', 'Enrollment initiative milestone completion rate', 'Stakeholder satisfaction with project updates and communication'], email: '', photoUrl: '../photos/enrollment/charles-crankson.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAmevpt63HgTreXjEGL0M9EAdyu6hNqyeGnyn7WtrmFhic?e=7CZh4x' },
  { id: 'mariela-pezzali', name: 'Mariela Gisell Pezzali', title: 'Project Manager', dept: 'dean', level: 3, status: 'Contractor', reportsTo: 'steven-thomas', role: 'pm', pmPosition: 'right',
    ...
    kpis: ['On-time delivery of DOS compliance and policy projects', 'Project milestone completion rate for student services initiatives', 'Stakeholder satisfaction with project coordination and reporting'], email: 'MarielaPezzali@churchofjesuschrist.org', photoUrl: '../photos/dean/mariela-pezzali.png', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAmevpt63HgTreXjEGL0M9EAdyu6hNqyeGnyn7WtrmFhic?e=7CZh4x' },
  { id: 'karina-vargas', name: 'Karina Andrea Vargas', title: 'Coordinator', dept: 'digital', level: 3, status: 'Contractor', reportsTo: 'jacob-adams', role: 'pm', pmPosition: 'right',
    responsibilities: ['Coordinate digital operations development and deployment projects', 'Track sprint deliverables, feature releases, and system integration milestones', 'Manage stakeholder reporting and project communication for digital initiatives'],
    kpis: ['On-time delivery of digital operations projects', 'Sprint and release milestone completion rate', 'Stakeholder satisfaction with project timeliness and communication'], email: 'karina_24@churchofjesuschrist.org', photoUrl: '../photos/digital/karina-vargas.jpeg', roleInventoryUrl: 'https://churchofjesuschrist.sharepoint.com/:w:/s/BYU-PathwayStudentSuccessRoleInventory/IQAmevpt63HgTreXjEGL0M9EAdyu6hNqyeGnyn7WtrmFhic?e=7CZh4x' }
];
