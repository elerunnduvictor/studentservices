...
insert into public.hub_access (email, full_name, category, role, scope_department, scope_person) values
  ...
  ('joanna.relken@byupw.edu', 'Johanna Relkin', 'Student Services - E&R', 'staff', 'Enrollment & Retention', 'Johanna Relkin'),
  ...
  ('austin@hirespringboard.com', 'Austin', 'Student Services - Springboard', 'staff', null, null),
  ('kathy.villeda@churchofjesuschrist.org', 'Kathy Villeda', 'Student Services - Springboard', 'staff', null, null),
